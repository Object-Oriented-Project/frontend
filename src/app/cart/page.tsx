export default function Cart() {
  ...
  return (
    <div>
      ...
      <button className="btn btn-xs sm:btn-sm md:btn-md lg:btn-lg mx-10 ">  Go back</button>
        <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">

          <h2 className="title font-manrope font-bold text-4xl leading-10 mb-8 pt-6 text-center text-black">Shopping Cart</h2>
          ...
          <div className="rounded-3xl border-2 border-gray-200 p-4 lg:p-8 grid grid-cols-12 mb-8 max-lg:max-w-lg max-lg:mx-auto gap-y-4 ">
            ...
            <div className="col-span-12 lg:col-span-10 detail w-full lg:pl-3">
              <div className="flex items-center justify-between w-full mb-4">
                <h5 className="font-manrope font-bold text-2xl leading-9 text-gray-900">Beef Wellington</h5>
              ...
              <p className="font-normal text-base leading-7 text-gray-500 mb-6">
                illet steak coated with pâté (often pâté de foie gras) and duxelles, wrapped in puff pastry<a href="javascript:;"
          ...
          <div className="max-lg:max-w-lg max-lg:mx-auto">
            <p className="font-normal text-base leading-7 text-gray-500 text-center mb-5 mt-6">Vat calculated at checkout</p>
            <button
