...
export default function Summary() {
  ...
  const menu11 = {
    ...
    ItemDescription:
      "A traditional Thai soup with fragrant lemongrass, galangal, and a spicy kick.",
  };
  const menu28 = {
  ...
  return (
    <div>
      <div className="flex h-screen w-full items-center justify-center bg-gray-600">
        <div
          className="w-80 rounded bg-cover bg-center bg-no-repeat px-6 pt-8 shadow-lg"
          style={{
            backgroundImage:
              "url(https://images.template.net/wp-content/uploads/2016/08/08114810/Rough-Blank-Crumpled-Paper-Texture.jpg)",
          }}
        >
        ...
        onClick={() => {
          ord.addProduct(
            new Food(
              menu11.ID,
              menu11.ItemName,
              menu11.ItemPriceLarge,
              "L",
              1,
              1,
            ),
          );
          console.log(ord.getProducts());
        }}
      >
